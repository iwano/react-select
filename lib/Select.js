...
var Select = _react2['default'].createClass({
	...
	handleFilterButtonClick: function handleFilterButtonClick(value, event) {
		event.preventDefault();
  ...
  */
	...
	renderOuter: function renderOuter(options, valueArray, focusedOption) {
		...
		return _react2['default'].createElement(
			...
			(function () {
				if (_this7.props.filterButtons) {
					return _react2['default'].createElement(
						'ul',
						{ className: 'tabs', onMouseDown: _this7.handleMouseDownOnMenu },
